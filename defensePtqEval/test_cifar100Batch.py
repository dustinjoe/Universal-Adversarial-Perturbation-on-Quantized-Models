...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 25 23:08:29 2022
...
modelFP32 = load_model(model_name='Hendrycks2020AugMix_ResNeXt', dataset='cifar100', threat_model='corruptions')
criterion = nn.CrossEntropyLoss()
min_pixel_value=0.0
max_pixel_value=1.0
classifier = PyTorchClassifier(
...
datPlt = accResults.T
titlestr = 'CIFAR100 PTQ Classification under Trainingset UAP'
...
filestr = 'accCifar100_PTQ_white_tr.png'
